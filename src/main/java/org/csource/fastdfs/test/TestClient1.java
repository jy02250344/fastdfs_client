	...
	public static void main(String args[]) {
		...
		try {
			...
			if (file_id == null) {
				...
				ServerInfo[] servers = tracker.getFetchStorages1(trackerServer,
						file_id);
				if (servers == null) {
				...
				slave_file_id = client.upload_file1(master_file_id,
			...
			if ((file_id = client.upload_file1(local_filename, null, meta_list)) != null) {
				...
				errno = client.download_file1(file_id, new DownloadFileWriter(
						"c:\\" + file_id.replaceAll("/", "-")));
				if (errno == 0) {
					System.err.println("Download file success");
				} else {
					System.err
				...
				file_ext_name = null;
				slave_file_id = client.upload_file1(master_file_id,
						prefix_name, local_filename, file_ext_name, meta_list);
				if (slave_file_id != null) {
					System.err.println("slave file_id: " + slave_file_id);
					System.err.println(client.get_file_info1(slave_file_id));
